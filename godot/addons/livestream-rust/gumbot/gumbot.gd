...
func _ready() -> void:
  ...
  var legs: MeshInstance3D = $Armature/Skeleton3D/Leg
  var sphere: MeshInstance3D = $Armature/Skeleton3D/Sphere_001
  var hand_l: MeshInstance3D = $Armature/Skeleton3D/Hand_L
  var hand_r: MeshInstance3D = $Armature/Skeleton3D/Hand_R
  # var windup: MeshInstance3D = $Armature/Skeleton3D/Windup
