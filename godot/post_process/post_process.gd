...
func get_shader_file() -> RDShaderFile:
  return load("res://post_process/post_process_underwater.glsl")
...
func _initialize_compute() -> void:
  ...
  # Compile our shader.
  var shader_file := get_shader_file()
  ...
  if rd and p_effect_callback_type == EFFECT_CALLBACK_TYPE_POST_TRANSPARENT and pipeline.is_valid():
    ...
    if render_scene_buffers and scene_data:
      ...
      for view in view_count:
        ...
        push_constant[3] = true # Cam underwater
        push_constant[4] = 1.0 # Focus amt
