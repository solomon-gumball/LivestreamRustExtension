...
func create_lobby(game_title: String, is_player: bool = true, close_existing: bool = false) -> String:
  var response: HTTPResult = await create_authorized_request(
    get_database_server_url("game-lobby"),
    HTTPClient.METHOD_POST,
    { "game": game_title, "is_player": is_player, "close_existing": close_existing }
  )
